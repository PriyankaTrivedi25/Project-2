...
<input type="radio" name="b" value="buy" checked="">Buy
    	<input type="radio" name="b" value="rent">Rent 
    	</div>
 ...
 <?php if (isset($_GET['rent'])) { ?>
     <a href="apartment.php?id=dc&&rent=rent">Price:Low to high</a>	
    <a href="apartment.php?rent=rent?id=ac">Price:High to low</a>
    <?php } else {?>
     <a href="apartment.php?id=dc">Price:High to low</a>	
    <a href="apartment.php?id=ac">Price:Low to high</a><?php } ?>
    </div>
</div></li>
								...
								if ($_GET['id']=='dc') 
										{
												...
												$q="select *from property where type='apartment' and buy_rent='rent'ORDER BY rate desc";
										}
									else
										{
									
												$q="select *from property where type='apartment' and buy_rent='rent' ORDER BY rate";
										}
									}
									else
									{
								$q="select * from property where type='apartment' and buy_rent='rent'";
							}
							}
							...
							{	
								if (isset($_GET['id'])) {
										...
										if ($_GET['id']=='dc') 
										{
												...
												$q="select *from property where type='apartment' and buy_rent='buy'ORDER BY rate desc";
										}
									else 
										{
									
												$q="select *from property where type='apartment' and buy_rent='buy' ORDER BY rate";
										}
									}
										else{			
										$q="select * from property where type='apartment' and buy_rent='buy'";
										}
