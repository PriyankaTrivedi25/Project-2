...
<form action="area.php" method="POST">				 
				<select name="pro_area" style="width:200px;height:25px">
	<?php
	session_start();
								include "connectin.php";
								$city=$_GET["pro_city"];
...
?>*/ 
    	 ...
    	 <input type="submit" name="search" value="search"style="width:60px;height:25px" style="background-color:blue;"/>   
    	    </form>
	...
	<!-- Header -->
		...
		<center>
						...
						<ul>
							...
							<?php } ?>
                    <?php if ($b_r=='buy'||isset($_GET['id']))
   {?>
						<li><div class="dropdown">
  Sort by
  <div class="dropdown-content">

   	<a href="sample.php?id=dc&&city=<?php echo $city?>">Price:High to low</a>	
    <a href="sample.php?id=ac&&city=<?php echo $city?>">Price:Low to high</a>
    <?php } ?>
