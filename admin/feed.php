    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
					...
					<li>	
                        <a href="room.php"><i class="fa fa-feed"></i><span class="nav-label">Property</span></a>
                    </li>
					<li>	
					...
					<li>	
                        <a href="#"><i class="fa fa-feed"></i><span class="nav-label">Feedback</span></a>
                    </li>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Welcome to Admin Pannel</span>
                </li>
                <li class="dropdown">
                ...
                <div class="col-lg-6" style="width:100%">
					...
					?>
							...
							<tr>
								...
								<td><?=$arr[2]?></td>
								<td><?=$arr[3]?></td>
								<td><a href="del_feed.php?fid=<?=$arr[4]?>" onclick="return confirm ('Are you sure you want to delete ? ');"><img src="d.png" height=30 width=30></a><d>
							</tr>
							<?php
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
                ...
                toastr.success('Welcome to Admin Pannel');
