...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.4/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Jan 2016 18:05:31 GMT -->
<head>
    ...
    <div id="wrapper">
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
					...
					<li>	
                        <a href="feed.php"><span class="nav-label">Feedback</span></a>
                    </li>
                </ul>
		...
		<!---------------------------------------------------------------------------------------------------------------------------------------->
                <div class="row  border-bottom white-bg dashboard-header">
					...
					<div id="img">
						<img src="building.jpg" height="100%" width="100%"><br>
